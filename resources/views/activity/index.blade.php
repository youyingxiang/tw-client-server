        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="tab_act">
                        <ul>
                            <a href="{{route("tw.activity.index",['level'=>1])}}"><li id="act_pt" @if(request()->input('level') ==1 || empty(request()->input('level'))) style="background: #4066b2;color: #fff" @endif>普通活动</li></a>
                            <a href="{{route("tw.activity.index",['level'=>2])}}"><li id="act_gj" @if(request()->input('level') ==2) style="background: #4066b2;color: #fff" @endif>高级活动</li></a>
